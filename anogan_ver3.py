...
Original file is located at
    https://colab.research.google.com/drive/1Oyupmk2t-sQFqjxaHqu0yAlnFXzC3HFU
"""
...
test_df['label'] = test_df['files'].apply(lambda x: x.split('_')[1])
